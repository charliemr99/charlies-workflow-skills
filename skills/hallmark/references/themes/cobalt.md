...
Loaded eagerly by SKILL.md Step 3 whenever the catalog pick is `cobalt`. The OKLCH palette + font stack live in [`site/css/tokens.css`](https://github.com/Nutlope/hallmark/blob/aeb42fb354ff4efa36ab475773a082315a3af2ce/site/css/tokens.css) under `[data-theme="cobalt"]`. Canonical build: [`site/examples/cobalt-01/`](https://github.com/Nutlope/hallmark/tree/aeb42fb354ff4efa36ab475773a082315a3af2ce/site/examples/cobalt-01) (an API product landing with a request/response hero).
...
Plus the Space Grotesk + Inter + JetBrains Mono link and the small reveal/type-in script. The canonical build to mirror is [`site/examples/cobalt-01/`](https://github.com/Nutlope/hallmark/tree/aeb42fb354ff4efa36ab475773a082315a3af2ce/site/examples/cobalt-01).
